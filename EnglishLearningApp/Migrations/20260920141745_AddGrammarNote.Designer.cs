...
namespace EnglishLearningApp.Migrations
{
    ...
    [Migration("20260920141745_AddGrammarNote")]
    partial class AddGrammarNote
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EnglishLearningApp.Entities.Content.GrammarStructureItem", b =>
                {
                    ...
                    b.HasIndex("GrammarNoteId");

                    b.ToTable("AppGrammarStructureItems", (string)null);
                });
            ...
            modelBuilder.Entity("EnglishLearningApp.Entities.Content.SentenceExercise", b =>
                {
                    ...
                    b.ToTable("AppSentenceExercises", (string)null);
                });
            ...
            modelBuilder.Entity("EnglishLearningApp.Entities.Progress.UserLessonReview", b =>
                {
                    ...
                    b.ToTable("AppUserLessonReviews", (string)null);
                });
            ...
            modelBuilder.Entity("EnglishLearningApp.Entities.Writing.UserWriting", b =>
                {
                    ...
                    b.ToTable("AppUserWritings", (string)null);
                });
            ...
            modelBuilder.Entity("EnglishLearningApp.Entities.Writing.WritingTopic", b =>
                {
                    ...
                    b.ToTable("AppWritingTopics", (string)null);
                });
            ...
            modelBuilder.Entity("EnglishLearningApp.Entities.Content.Chapter", b =>
                {
                    b.HasOne("EnglishLearningApp.Entities.Content.Level", "Level")
                        .WithMany("Chapters")
            ...
            modelBuilder.Entity("EnglishLearningApp.Entities.Content.GrammarStructureItem", b =>
                {
                    b.HasOne("EnglishLearningApp.Entities.Content.GrammarNote", "GrammarNote")
                        .WithMany("Structures")
                        .HasForeignKey("GrammarNoteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("GrammarNote");
                });
            ...
            modelBuilder.Entity("EnglishLearningApp.Entities.Content.Lesson", b =>
                {
                    b.Navigation("SentenceExercises");
