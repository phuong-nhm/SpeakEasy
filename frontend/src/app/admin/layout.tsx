  ...
  const navItems = [
    {
      ...
      items: [
        ...
        { name: "4. Quản lý Grammar Note", href: "/admin/grammar-notes" },
        { name: "5. Từ vựng (Vocabulary)", href: "/admin/vocabularies" },
        { name: "6. Bài tập Xếp câu", href: "/admin/sentence-exercises" },
        { name: "7. Quản lý Listening", href: "/admin/listening" },
        { name: "8. Topic Bài viết AI", href: "/admin/writing-topics" },
      ],
    },
    {
